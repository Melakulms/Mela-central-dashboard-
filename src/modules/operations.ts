...
export const operationalModules: AdminModule[] = [
  ...
  { id: 'opportunities', label: 'Opportunities', permission: 'opportunities.manage', description: 'Review employers and approve or reject listings.', actions: ['review', 'approve', 'reject'] },
  { id: 'payments', label: 'Payments', permission: 'finance.read', description: 'Monitor payments, escrow, coins and payout queues.', actions: ['inspect', 'reconcile', 'review-payout'] },
  { id: 'disputes', label: 'Disputes', permission: 'disputes.manage', description: 'Handle support tickets, SLA escalation and disputes.', actions: ['assign', 'escalate', 'resolve'] },
  ...
  { id: 'access', label: 'Authorization', permission: 'access.manage', description: 'Manage roles, permissions, access requests and RLS visibility.', actions: ['inspect', 'approve-request', 'revoke'] },
